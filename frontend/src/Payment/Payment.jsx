...
const CardField = ({ onChange }) => (
  <div style={{height:"36px",paddingLeft:"10px",paddingTop:"10px"}}>
...
const CheckoutForm = ({price,setModal}) => {
  ...
  useEffect(()=>{
    if(paymentMethod){
      setTimeout(()=>{ cart_empty_call(`${process.env.REACT_APP_backend_url}/cart/empty`,dispatch)},1000)
